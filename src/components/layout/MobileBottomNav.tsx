...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
      {/* Glass Background */}
      <div className="bg-white/90 backdrop-blur-xl border-t border-slate-200/60 px-2 pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
                ...
                >
                  <div className={`
                    ...
                    ${isActive
                      ...
                      : 'bg-blue-500 shadow-blue-500/20 hover:scale-105'
                    }
                  `}>
            ...
            return (
              ...
              >
                <item.icon
                  ...
                  className={`w-5 h-5 transition-colors ${isActive ? 'text-blue-500' : 'text-slate-400'}`}
                />
