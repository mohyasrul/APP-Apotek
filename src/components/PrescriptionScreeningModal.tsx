...
export function PrescriptionScreeningModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-zinc-900/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={onClose}>
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="prescription-screening-title"
        className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col animate-in fade-in zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-zinc-800 shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-indigo-50 dark:bg-indigo-900/30 rounded-xl">
              <ClipboardText weight="duotone" className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
            </div>
            <div>
              <h3 id="prescription-screening-title" className="font-bold text-gray-900 dark:text-gray-100">Skrining Resep</h3>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
                  ...
                  <label
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-colors ${
                      checklist[item.key as keyof ScreeningChecklist]
                        ...
                        : 'bg-gray-50 dark:bg-zinc-800 border border-transparent hover:border-gray-200 dark:hover:border-zinc-700'
                    }`}
                  >
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-gray-300 text-emerald-500 focus:ring-emerald-500/20 w-4 h-4"
                    />
          ...
          {/* Result */}
          <div>
            <h4 className="text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">Hasil Skrining</h4>
          ...
          {/* Notes */}
          <div>
            <label className="block text-xs text-gray-400 dark:text-gray-500 mb-1">Catatan Skrining</label>
            <textarea
              value={catatan}
